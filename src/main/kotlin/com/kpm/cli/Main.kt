...
private fun showHelp() {
    ...
    println("  add      Add a dependency or create a Compose Multiplatform project")
    ...
    println("  kpm add MyApp --cmp --android --ios                 # Create CMP project for Android & iOS")
    println("  kpm add MyApp --cmp --android --ios --desktop       # Create CMP project with Desktop")
    println("  kpm add MyApp --cmp --android --ios --server        # Create CMP with Ktor server")
