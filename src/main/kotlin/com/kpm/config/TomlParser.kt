...
class TomlParser {
    ...
    private fun buildTomlContent(manifest: KpmManifest): String {
        ...
        // Add plugins section for non-Android projects only
        // Android projects use gradle/libs.versions.toml for version catalog
        if (manifest.plugins.isNotEmpty() && 
            manifest.project.type != ProjectType.ANDROID_APP && 
            manifest.project.type != ProjectType.ANDROID_LIBRARY) {
